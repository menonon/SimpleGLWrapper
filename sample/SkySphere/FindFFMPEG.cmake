...
IF(WIN32)
	...
	SET(FFMPEG_LIBRARY_DIR ${FFMPEGDIR}\\lib CACHE PATH "Location of the AV libraries")
	SET(FFMPEG_INCLUDE_PATHS ${FFMPEGDIR}\\include CACHE PATH "Location of the AV library headers")
ELSE()
...
FOREACH(LIB ${FFMPEG_LIBRARIES})
	...
	FIND_LIBRARY(LIB_PATH NAMES ${LIB} HINTS ${FFMPEG_LIBRARY_DIR} $ENV{HOME}/progs/libavstatic/lib)
	IF(LIB_PATH)
